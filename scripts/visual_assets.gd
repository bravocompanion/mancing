...
# Rectangles are based on the generated 1448x1086 master sheet.
# They deliberately crop only the character artwork, excluding row labels.
const MC_FRAMES := {
    "idle": [
        Rect2(205, 0, 145, 165), Rect2(355, 0, 145, 165), Rect2(505, 0, 145, 165), Rect2(655, 0, 145, 165)
    ],
    "walk": [
        Rect2(195, 155, 145, 150), Rect2(340, 155, 145, 150), Rect2(485, 155, 145, 150), Rect2(630, 155, 145, 150),
        Rect2(775, 155, 145, 150), Rect2(920, 155, 145, 150), Rect2(1065, 155, 145, 150), Rect2(1210, 155, 145, 150)
    ],
    "run": [
        Rect2(195, 300, 150, 150), Rect2(345, 300, 150, 150), Rect2(495, 300, 150, 150), Rect2(645, 300, 150, 150),
        Rect2(795, 300, 150, 150), Rect2(945, 300, 150, 150), Rect2(1095, 300, 150, 150), Rect2(1245, 300, 150, 150)
    ],
    "cast": [
        Rect2(185, 445, 190, 150), Rect2(375, 445, 190, 150), Rect2(565, 445, 190, 150),
        Rect2(755, 445, 190, 150), Rect2(945, 445, 190, 150), Rect2(1135, 445, 250, 150)
    ],
    "reel": [
        Rect2(190, 590, 180, 150), Rect2(370, 590, 180, 150), Rect2(550, 590, 180, 150),
        Rect2(730, 590, 180, 150), Rect2(910, 590, 180, 150), Rect2(1090, 590, 240, 150)
    ],
    "caught": [
        Rect2(200, 735, 165, 145), Rect2(365, 735, 165, 145), Rect2(530, 735, 165, 145), Rect2(695, 735, 165, 145)
    ],
    "tired": [
        Rect2(200, 865, 165, 120), Rect2(365, 865, 165, 120), Rect2(530, 865, 210, 120), Rect2(740, 865, 210, 120)
    ],
    "wait": [
        Rect2(200, 970, 200, 115), Rect2(400, 970, 200, 115), Rect2(600, 970, 200, 115), Rect2(800, 970, 230, 115)
    ]
}
...
func _install_mc() -> void:
    var texture := load(MC_SHEET) as Texture2D
    if texture == null:
        return
...
func _process(delta: float) -> void:
    ...
    var moved := p.distance_to(last_player)
    last_player = p
    var next_anim := "idle"
    ...
    if current_anim in ["cast", "reel"]: fps = 8.0
    anim_time += delta
    if anim_time >= 1.0 / fps:
        anim_time = 0.0
        frame_index = (frame_index + 1) % (MC_FRAMES[current_anim] as Array).size()
        _set_frame(load(MC_SHEET) as Texture2D, current_anim, frame_index)

    # Face the movement direction while keeping artwork readable.
    var dx := p.x - last_player.x
    if abs(dx) > 0.3:
        mc_sprite.flip_h = dx < 0.0
...
func _set_frame(sheet: Texture2D, anim: String, index: int) -> void:
